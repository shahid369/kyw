...
class GuideContent {
  ...
  final String whatIsHappeningHeading;
  final String whatIsHappeningBody;
  final List<String> dos;
  final List<String> donts;
  final List<String> tipOfTheDay;
  final String communicationScript;

  const GuideContent({
    required this.phase,
    required this.title,
    required this.subtitle,
    required this.whatIsHappeningHeading,
    required this.whatIsHappeningBody,
    required this.dos,
    required this.donts,
    required this.tipOfTheDay,
    required this.communicationScript,
  });
}

class GuideContentLibrary {
  static const Map<CyclePhase, GuideContent> content = {
    CyclePhase.menstrual: GuideContent(
      phase: CyclePhase.menstrual,
      title: 'Her Period Is Here',
      subtitle: 'Days of rest, not demands',
      whatIsHappeningHeading: "What's Happening Inside Her Body",
      whatIsHappeningBody:
    ...
    CyclePhase.follicular: GuideContent(
    ...
    CyclePhase.ovulation: GuideContent(
    ...
    CyclePhase.luteal: GuideContent(
  ...
  static String getRandomTip(CyclePhase phase) {
    if (phase == CyclePhase.unknown) return content[CyclePhase.unknown]!.tipOfTheDay.first;
    final tips = content[phase]!.tipOfTheDay;
